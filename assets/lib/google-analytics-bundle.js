(function() {
  var g, aa = aa || {},
    ...
    r = function(a, b, c) {
      r = Function.prototype.bind && -1 != Function.prototype.bind.toString().indexOf("native code") ? fa : ga;
  ...
  var w = Array.prototype,
    ...
    la = w.some ? function(a, b, c) {
      ...
      for (var d = a.length, e = n(a) ? a.split("") :
          a, f = 0; f < d; f++)
        if (f in e && b.call(c, e[f], f, a)) return !0;
      return !1
    },
    ma = w.every ? function(a, b, c) {
  ...
  var ua = function(a, b, c) {
    ...
    za = function(a, b) {
      for (var c, d, e = 1; e < arguments.length; e++) {
        d = arguments[e];
        for (c in d) a[c] = d[c];
        for (var f = 0; f < ya.length; f++) c =
          ya[f], Object.prototype.hasOwnProperty.call(d, c) && (a[c] = d[c])
      }
    };
  var x = function(a, b) {
    this.p = {};
  ...
  x.prototype.remove = function(a) {
    return y(this.p, a) ? (delete this.p[a], this.h--, this.oa++, this.b.length > 2 * this.h && Aa(this), !0) : !1
  };
  var Aa = function(a) {
    if (a.h != a.b.length) {
    ...
    if (a.h != a.b.length) {
      for (var e = {}, c = b = 0; b < a.b.length;) d = a.b[b], y(e, d) || (a.b[c++] = d, e[d] = 1), b++;
      a.b.length = c
    }
  };
  g = x.prototype;
  ...
  var Ba, Ca, Da = {
    ...
    Ma = function(a) {
      if (1 > a || 200 < a) throw Error("Expected metric index range 1-200, but was : " +
        a);
      return {
        id: "metric" + a,
        name: "cm" + a,
  ...
  g.Ca = function() {
    ...
    if (!q(this.e)) throw Error("Must specify a delegate filter using #applyFilter.");
    return r(function(a) {
  ...
  var Qa = function(a, b) {
    ...
    a.za = r(function(a) {
      var d = a.T().get(Ja),
        e = a.T().get(Ia);
      ea(d) && (d = b(d), null != e && this.Ab && (d = e + this.Bb + d), a.T().set(Ia, d))
    }, a);
    return a
  };
  A.prototype.Ca = function() {
    ...
    return Pa().zb("event").xb(r(function(a) {
      this.za(a);
  ...
  var Ra = function(a, b) {
      ...
      return d.replace(/%([0\-\ \+]*)(\d+)?(\.(\d+))?([%sfdiu])/g, function(a, b, d, l, N, J, U, V) {
        if ("%" == J) return "%";
        var Db = c.shift();
        if ("undefined" == typeof Db) throw Error("[goog.string.format] Not enough arguments");
        arguments[0] = Db;
  ...
  var Sa = function(a) {
    ...
    Ta = function(a, b) {
      if ("function" == typeof a.forEach) a.forEach(b, void 0);
        ...
        for (var d = Sa(a), e = d.length, f = 0; f < e; f++) b.call(void 0, d[f], c && c[f],
          a)
      }
    };
  var C = function(a) {
  ...
  var Za = H("Opera") || H("OPR"),
    ...
    ab = function() {
      ...
      K ? b = /rv\:([^\);]+)(\)|;)/ : I ? b = /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/ : L && (b = /WebKit\/(\S+)/);
      b && (a = (a = b.exec(G)) ? a[1] : "");
      ...
      if (!(b = bb[a])) {
        ...
        for (var c = String(ab).replace(/^[\s\xa0]+|[\s\xa0]+$/g, "").split("."), d = String(a).replace(/^[\s\xa0]+|[\s\xa0]+$/g, "").split("."), e = Math.max(c.length, d.length), f = 0; 0 == b && f < e; f++) {
          ...
          do {
            ...
            b = ia(0 == U[1].length ? 0 : parseInt(U[1], 10), 0 == V[1].length ? 0 : parseInt(V[1], 10)) || ia(0 == U[2].length, 0 == V[2].length) || ia(U[2], V[2])
          } while (0 ==
            b)
        }
        b = bb[a] = 0 <= b
    ...
    cb = h.document,
    db = cb && I ? $a() || ("CSS1Compat" == cb.compatMode ? parseInt(ab, 10) : 5) : void 0;
  var eb = !I || I && 9 <= db,
    fb = I && !M("9"),
    gb = !L || M("528"),
    hb = K && M("1.9b") || I && M("8") || Za && M("9.5") || L && M("528"),
    ib = K && !M("8") || I && !M("9");
  var O = function(a, b) {
  ...
  P.prototype.add = function(a, b, c, d, e) {
    ...
    a = this.j[f];
    a || (a = this.j[f] = [], this.Z++);
    var k = ob(a, b, d, e); - 1 < k ? (b = a[k], c || (b.qa = !1)) : (b = new mb(b, this.src, f, !!d, e), b.qa = c, a.push(b));
    return b
  };
  P.prototype.remove = function(a, b, c, d) {
    ...
    var e = this.j[a];
    b = ob(e, b, c, d);
    return -1 < b ? (nb(e[b]), w.splice.call(e, b, 1), 0 == e.length && (delete this.j[a], this.Z--), !0) : !1
  };
  var pb = function(a, b) {
    var c = b.type;
  ...
  var qb = "closure_lm_" + (1E6 * Math.random() | 0),
    ...
    vb = function(a, b, c, d, e, f) {
      ...
      d.src = a;
      d.O = c;
      a.addEventListener ? a.addEventListener(b.toString(), d, k) : a.attachEvent(yb(b.toString()), d);
      sb++;
      return c
    },
    xb = function() {
    ...
    Bb = function(a, b, c, d, e) {
      ...
      else c = ub(c), kb(a) ? a.Va(b, c, d, e) : a && (a = wb(a)) && (b = a.X(b, c, !!d, e)) && Cb(b)
    },
    Cb = function(a) {
      ...
      var c = a.type,
        d = a.proxy;
      b.removeEventListener ? b.removeEventListener(c, d, a.pa) : b.detachEvent && b.detachEvent(yb(c), d);
      sb--;
      (c = wb(b)) ? (pb(c, a), 0 == c.Z && (c.src = null, b[qb] = null)) : nb(a);
      return !0
    },
    yb = function(a) {
    ...
    zb = function(a, b) {
      ...
      if (!eb) {
        ...
        if (!(0 > e.keyCode || void 0 != e.returnValue)) {
          ...
          for (var f = a.type, l = e.length - 1; !c.U && 0 <= l; l--) c.currentTarget = e[l],
          d &= Fb(e[l], f, !0, c);
          for (l = 0; !c.U && l < e.length; l++) c.currentTarget = e[l],
          d &= Fb(e[l], f, !1, c)
        }
        return d
      }
  ...
  g.dispatchEvent = function(a) {
    ...
    var e = !0,
      f;
    if (b)
      for (var k = b.length - 1; !a.U && 0 <= k; k--) f = a.currentTarget = b[k], e = Hb(f, d, !0, a) && e;
    a.U || (f = a.currentTarget = c, e = Hb(f, d, !0, a) && e, a.U || (e = Hb(f, d, !1, a) && e));
    if (b)
      for (k = 0; !a.U && k < b.length; k++) f = a.currentTarget = b[k], e = Hb(f, d, !1, a) && e;
    return e
  };
  g.l = function() {
    Q.L.l.call(this);
  ...
  var Qb = function(a, b) {
    ...
    Lb, Mb = function() {
      if (h.Promise && h.Promise.resolve) {
        ...
        var a = Rb;
        !p(h.setImmediate) || h.Window && h.Window.prototype.setImmediate == h.setImmediate ? (Jb || (Jb = Kb()), Jb(a)) : h.setImmediate(a)
      }
    },
    Nb = !1,
    Ob = [],
      ...
      if (0 == a.m)
        if (a.o) {
          ...
          if (c.n) {
            ...
            0 <= e && (0 == c.m && 1 == d ? Xb(c, b) : (d = c.n.splice(e, 1)[0], Yb(c), d.Ma(b)))
          }
        } else Ub(a, 3, b)
    },
    $b = function(a, b) {
  ...
  */
    ...
    fc = function(a) {
      ...
      for (var b = a.v, d = c = !1; a.ja.length && !a.Ja;) {
        ...
        if (f = a.W ? k : f) try {
          ...
          void 0 !== l && (a.W = a.W && (l == b || l instanceof Error), a.v = b = l);
          Tb(b) && (d = !0, a.Ja = !0)
        } catch (N) {
          b = N, a.W = !0, kc(a) || (c = !0)
        }
      ...
      a.v = b;
      d && (l = r(a.ib,
        a, !0), d = r(a.ib, a, !1), b instanceof S ? (ic(b, l, d), b.Lb = !0) : b.then(l, d));
  ...
  qc.prototype.send = function(a, b) {
    for (var c = new T(a, b), d = 0; d < this.$a.length && (this.$a[d](c), !c.Za); d++);
  ...
  g.send = function(a, b) {
    ...
    var c = this.sb.clone();
    b instanceof C ? c.ia(b) : q(b) && ua(b, function(a, b) {
      null != a && c.set(Fc(b), a)
    }, this);
  ...
  var Mc = function(a, b, c, d, e, f) {
    ...
    this.Nb = !!c;
    this.Mb = !!d;
    for (b = this.mb = 0; b < a.length; b++) ic(a[b], r(this.rb, this, b, !0), r(this.rb, this, b, !1));
    ...
    Rc = function(a) {
      return a.H.get("analytics.user-id").J(function(a) {
        if (!a) {
          ...
          for (var c = 0, d = a.length; c < d; c++) switch (a[c]) {
            case "x":
  ...
  g.lc = function() {
    if (this.enabled) {
      var a = s() - this.Ta;
      0 < a && a < .8 * this.ya ? this.g = this.R.setTimeout(this.Ra, this.ya - a) : (this.g && (this.R.clearTimeout(this.g), this.g = null), this.dispatchEvent("tick"), this.enabled && (this.g = this.R.setTimeout(this.Ra, this.ya), this.Ta = s()))
    }
  };
  g.start = function() {
    this.enabled = !0;
  ...
  var $c = function(a, b, c, d, e, f) {
    if (m(c))
      for (var k = 0; k < c.length; k++) $c(a, b, c[k], d, e, f);
    else {
  ...
  Z.prototype.Va = function(a, b, c, d, e) {
    ...
    else c = c || this.handleEvent, e = e || this.Ua || this, c = ub(c), d = !!d, b = kb(a) ? a.X(b, c, d, e) : a ? (a = wb(a)) ? a.X(b, c, d, e) : null : null, b && (Cb(b), delete this.b[b.key]);
    return this
  };
  ...
  var ad = function() {
    Q.call(this);
    this.ta = new Z(this);
    gb && (hb ? this.ta.listen(ib ? document.body : window, ["online", "offline"], this.tb) : (this.ub = gb ? navigator.onLine : !0, this.g = new Xc(250), this.ta.listen(this.g, "tick", this.ac), this.g.start()))
  };
  u(ad, Q);
  ...
  kd.prototype.send = function(a, b) {
    var c = b.get(vc),
      ...
      d;
    "timing" != a ? d = this.k.V : ((d = b.get(yc)) && b.remove(yc), d || (d = this.k.V));
  ...
  var ld = /^(?:([^:/?#.]+):)?(?:\/\/(?:([^/?#]*)@)?([^/#?]*?)(?::([0-9]+))?(?=[/#?]|$))?([^?#]+)?(?:\?([^#]*))?(?:#(.*))?$/,
    ...
    nd = function(a, b) {
      if (md) {
        ...
        if (c) {
          var d = c.href;
          if (d && (d = (d = nd(3, d)) ? decodeURI(d) : d) && d != c.hostname) throw md = !0, Error();
        }
      }
  ...
  var qd = function(a) {
    var b;
    (b = a.Eb) || (b = {}, pd(a) && (b[0] = !0, b[1] = !0), b = a.Eb = b);
    return b
  };
  var rd, sd = function() {};
  u(sd, od);
  ...
  $.prototype.send = function(a, b, c, d) {
    ...
    d = oa(f.F());
    c = h.FormData && a instanceof
    h.FormData;
    !(0 <= ja(vd, b)) || d || c || f.set("Content-Type", "application/x-www-form-urlencoded;charset=utf-8");
    ...
    try {
      yd(this), 0 < this.ea && ((this.Ga = zd(this.a)) ? (this.a.timeout = this.ea, this.a.ontimeout = r(this.fb, this)) : this.da = Yc(this.fb, this.ea, this)), this.aa = !0, this.a.send(a), this.aa = !1
    } catch (k) {
      this.ga(5, k)
    }
  };
  ...
  $.prototype.fb = function() {
    "undefined" != typeof aa && this.a && (this.ba = "Timed out after " + this.ea + "ms, aborting", this.dispatchEvent("timeout"), this.abort(8))
  };
  ...
  $.prototype.abort = function() {
    this.a && this.D && (this.D = !1, this.K = !0, this.a.abort(), this.K = !1, this.dispatchEvent("complete"), this.dispatchEvent("abort"), Bd(this))
  };
  $.prototype.l = function() {
    this.a && (this.D && (this.D = !1, this.K = !0, this.a.abort(), this.K = !1), Bd(this, !0));
    $.L.l.call(this)
  };
  ...
  var Cd = function(a) {
      if (a.D && "undefined" != typeof aa && (!a.ca[1] || 4 != Dd(a) || 2 != Ed(a)))
  ...
  g.remove = function(a) {
    Hd(this);
    a = Gd(this, a);
    return this.c.Q(a) ? (this.r = null, this.h -= this.c.get(a).length, this.c.remove(a)) : !1
  };
  g.Q = function(a) {
    Hd(this);
    a = Gd(this, a);
  ...
  Id.prototype.send = function(a, b) {
    ...
    var c = new S,
      d = Jd(a, b);
    d.length > this.na ? c.w({
      status: "payload-too-big",
      Ba: Ra("Encoded hit length == %s, but should be <= %s.", d.length, this.na)
    }) : xd(this.$b, function() {
      c.G(hd)
    }, d);
    return c
  ...
  Kd.prototype.Sa = function() {
    if (!this.q) {
      var a = this.k;
      if (!jc(a.ha).C) throw Error("Cannot construct shared channel prior to settings being ready.");
      new ad;
  ...
  t("analytics.getService", function(a) {
    ...
    if (null === b) {
      ...
      if (!Ca) {
        var d = Md();
        Ca = new Wc(d, new Kd(d, "https://www.google-analytics.com/collect", 8192))
      }
  ...
  t("analytics.internal.GoogleAnalyticsService.prototype.getTracker", Hc.prototype.Cc);
  t("analytics.internal.GoogleAnalyticsService.prototype.getConfig", Hc.prototype.Bc);
  t("analytics.internal.ServiceSettings", X);
  t("analytics.internal.ServiceSettings.prototype.setTrackingPermitted", X.prototype.Lc);
  t("analytics.internal.ServiceSettings.prototype.isTrackingPermitted", X.prototype.va);
  t("analytics.internal.ServiceSettings.prototype.setSampleRate", X.prototype.Kc);
  ...
  t("analytics.internal.ServiceTracker.prototype.sendException", W.prototype.Ic);
  ...
  t("analytics.internal.ServiceTracker.Timing.prototype.send", Gc.prototype.send);
  t("analytics.internal.ServiceTracker.prototype.forceSessionStart", W.prototype.Ac);
  t("analytics.internal.ServiceTracker.prototype.addFilter", W.prototype.S);
  t("analytics.internal.FilterChannel.Hit", T);
  t("analytics.internal.FilterChannel.Hit.prototype.getHitType", T.prototype.Gb);
  t("analytics.internal.FilterChannel.Hit.prototype.getParameters", T.prototype.T);
  t("analytics.internal.FilterChannel.Hit.prototype.cancel", T.prototype.cancel);
  ...
  t("analytics.filters.EventLabelerBuilder.prototype.appendToExistingLabel", A.prototype.wc);
  t("analytics.filters.EventLabelerBuilder.prototype.stripValue", A.prototype.Nc);
  t("analytics.filters.EventLabelerBuilder.prototype.powersOfTwo", A.prototype.Ec);
  t("analytics.filters.EventLabelerBuilder.prototype.rangeBounds", A.prototype.Fc);
